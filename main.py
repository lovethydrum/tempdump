...
main_menu_numbers_button = MenuButton(390, 200, WHITE)
main_menu_numbers_button.width, main_menu_numbers_button.height = 400, 200
main_menu_button_3 = MenuButton(390, 480, WHITE)
main_menu_button_3.width, main_menu_button_3.height = 400, 200
...
clock_menu_duel_button = MenuButton(750, 250, RED)
...
def draw_main_menu():
    ...
    # game_window.blit(end_score_font.render("Practice", True, (0, 0, 0), ), (126, 260))
    main_menu_numbers_button.draw_button()
    game_window.blit(end_score_font.render("Numbers", True, (0, 0, 0), ), (404, 250))
    menu_title = menu_font.render("Game Modes", True, (0, 0, 0), )
    main_menu_button_3.draw_button()
    game_window.blit(end_score_font.render("Time", True, (0, 0, 0), ), (484, 540))
    ...
    game_window.blit(menu_title, (270, 30))
    pygame.display.update()
...
def draw_clock_menu():
    ...
    game_window.blit(fight_image, (752, 252))
    game_window.blit(menu_font.render(f"BATTLE", True, (0, 0, 0), ), (745, 140))
    clock_menu_practice_button.draw_button()
    clock_menu_reference_button.draw_button()
    game_window.blit(timer_font.render(f"Practice", True, (0, 0, 0), ), (85, 170))
    game_window.blit(timer_font.render(f"Listening", True, (0, 0, 0), ), (78, 470))
    pygame.display.update()
    ...
    if game_state == "main menu":
        ...
        for event in ev:
            if event.type == pygame.QUIT:
                ...
                elif main_menu_button_3.rect.collidepoint(event.pos):
                    draw_clock_menu()
        ...
        for event in ev:
            if event.type == pygame.QUIT:
                ...
                if clock_menu_duel_button.rect.collidepoint(event.pos):
                    scoreboard.duel_player_1 = 50
                    scoreboard.duel_player_2 = 50
